...
The v1.0.0 list — denied permission prompts, no printing/PDF, no reader view, no password autofill wiring, hosts-only blocking, no YouTube layer — is **fully resolved in this release**. What remains honest to state:
...
- In-app filter-list refresh (between app updates) is planned for v1.2; rules ship fresh with every release and CI regenerates them weekly.
